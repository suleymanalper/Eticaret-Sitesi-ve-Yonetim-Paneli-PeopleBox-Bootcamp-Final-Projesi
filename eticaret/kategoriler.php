...
<head>
   ...
   <title><?php echo $kategoricek['kategori_ad'] ?> - Salper E-Ticaret</title>
                                          ...
                                          <div class="productwrap">
                                                 <div class="pr-img">
                                                        ...
                                                        <div class="pricetag on-sale">
                                                               <div class="inner on-sale"><span class="onsale"><span class="oldprice"><?php echo $uruncek['urun_fiyat'] * 1.50 ?> TL</span><?php echo $uruncek['urun_fiyat'] ?></span></div>
                                                        </div>
                                                 </div>
