...
if (isset($_SESSION['userkullanici_mail'])) {
  ...
  $kullanicicek = null; // Kullanıcı giriş yapmamışsa null olarak ayarlıyoruz
}
                ...
                <table class="table table-condensed popcart-inner">
                  <tbody>
                    ...
                    while ($sepetcek = $sepetsor->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      if(isset($toplam_fiyat, $uruncek['urun_fiyat'], $sepetcek['urun_adet'])): ?>
                        <?php $toplam_fiyat += $uruncek['urun_fiyat'] * $sepetcek['urun_adet']; ?>
                    <?php endif;
                    ?>
