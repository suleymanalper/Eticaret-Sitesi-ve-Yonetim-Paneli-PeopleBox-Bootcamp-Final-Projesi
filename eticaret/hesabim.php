	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
              ...
              if (isset($_GET['durum'])) {
				...
				<div class="form-group dob">
					<div class="col-sm-12">
						...
						<input type="text" class="form-control"  required="" name="kullanici_adsoyad"placeholder="Ad Soyad" value="<?php echo $kullanicicek['kullanici_adsoyad'] ?>">
					</div>
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle"><img width="400" src="dimg/passwords.jpg"></a></center>
			</div>
		</div>
	</div>
</form>
