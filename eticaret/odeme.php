            ...
            <form action="nedmin/netting/islem.php" method="POST">
                <tbody>
                    ...
                    while($sepetcek = $sepetsor->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $urun_toplam_fiyat = $uruncek['urun_fiyat'] * $sepetcek['urun_adet'];
                    ...
                    <tr>
                        ...
                        <td><?php echo $urun_toplam_fiyat ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
        ...
        <div class="tab-review">
            ...
            <div id="myTabContent" class="tab-content shop-tab-ct">
                <div class="tab-pane fade active in" id="desc">
                    <p>Kredi Kartı Entegrasyonu yapılacktır, Sabrınız için teşekkür ederiz.</p>
                </div>

                <div class="tab-pane fade " id="rev">
                    <p>Ödeme yapacağınız hesap numarasını seçerek işlemi tamamlayınız. İbanı Not Alınız</p>
                    <?php 
